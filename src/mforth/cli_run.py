...
# Idempotent registration guard — re-importing this module (test
# reset-and-replay loops) must not raise the duplicate-name ValueError.
if "run" not in __import__("mforth.cli", fromlist=["_REGISTRY"])._REGISTRY:
    register_subcommand(
        "run",
